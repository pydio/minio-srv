...
lint:
	@echo "Running $@"
	@${GOPATH}/bin/golint -set_exit_status github.com/pydio/minio-priv/cmd...
	@${GOPATH}/bin/golint -set_exit_status github.com/pydio/minio-priv/pkg...
...
test: verifiers build
	...
	@go test $(GOFLAGS) .
	@go test $(GOFLAGS) github.com/pydio/minio-priv/cmd...
	@go test $(GOFLAGS) github.com/pydio/minio-priv/pkg...
