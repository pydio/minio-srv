...
type gatewayPydioAPIHandlers struct {
	objectAPIHandlers
	ObjectAPI func() GatewayLayer
	PydioAPI  func() PydioGateway
}

// registerAPIRouter - registers S3 compatible APIs.
func registerGatewayPydioAPIRouter(mux *router.Router, gw GatewayLayer) {
	// Initialize API.
	api := gatewayPydioAPIHandlers{
		ObjectAPI: func() GatewayLayer { return gw },
		PydioAPI:  func() PydioGateway { return gw.(PydioGateway) },
